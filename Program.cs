...
namespace az204_blobdemo
{
    class Program
    {
        ...
        private static async Task ProcessAsync()
        {
            ...
            string storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=az204blobdemo94045;AccountKey=Rki2c/Sl1fBcoz9t72WqeVGd9DHvs8lNs/B3xU27SZ4iFZLkqcIPh2vjKj9LrFvjfQo0TFTgPTyGmsQJ1SJZMg==;EndpointSuffix=core.windows.net";
            ...
            if (CloudStorageAccount.TryParse(storageConnectionString, out storageAccount))
            {
                ...
                CloudBlobContainer cloudBlobContainer = cloudBlobClient.GetContainerReference("demoblobs");
